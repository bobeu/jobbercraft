...
import {Blockie, ZERO_ADDR} from "./Blockie";
...
const Address = (props: AddressProps ) => {
  ...
  return (
    <div className="flex justify-start items-center gap-2 text-cyan-300 font-semibold">
      <span ><Blockie account={wrapToText(account)} size={size} /></span> 
      <a href={`https://mumbai.polygonscan.com/address/${account}`} rel="noreferrer" target="_blank">{size ? getEllipsisTxt(wrapToText(account || ZERO_ADDR), size) : account}</a>
